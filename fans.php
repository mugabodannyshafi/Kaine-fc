                                   ...
                                   if($dob ==""){
                                    ...
                                    ?>
                                      <tr>
                                        ...
                                        <td>
                                         <a  href="update_fans.php?id=<?php echo $row['id'] ?>" title="Update"><i class="fa fa-edit text-info"></i></a>
                                         <a href="delete_fans.php?deleteid=<?php echo $row['id'] ?>" onclick="return confirm('Are you sure you want to delete')" title="Delete"><i class="fa fa-trash text-danger"></i></a>
                                        </td>
                                        <?php
                                        $cid++;
                                }
